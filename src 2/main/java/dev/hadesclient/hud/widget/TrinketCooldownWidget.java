...
public final class TrinketCooldownWidget extends HudWidget {
    ...
    public String description() {
        return enabled() ? "Timers for defined trinkets" : "Hidden";
    }
    ...
    private void drawRow(DrawContext g, Theme theme, float x, float y, ActiveCooldown cooldown) {
        ...
        Draw.roundRect(g, x, y, WIDTH, ROW_H, 5f, bg);
        Draw.roundOutline(g, x, y, WIDTH, ROW_H, 5f, 1f, edge.alpha(0.6f));
        ...
        Draw.text(g, rightText, x + WIDTH - rw - PAD,
