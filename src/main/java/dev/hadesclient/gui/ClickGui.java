 ...
 * and a scrollable grid of cards. No more paging — everything that fits in
 * the current filter is stacked and scrolled through vertically. The search
 * box in the top-right narrows results across the whole active tab.
 */
