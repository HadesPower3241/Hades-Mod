...
import dev.hadesclient.hud.widget.StrongholdBeaconWidget;
...
public final class HadesClient implements ClientModInitializer {
    ...
    private static void route(String raw) {
        try {
            ...
            StrongholdBeaconWidget beacon = (StrongholdBeaconWidget) hud.get("stronghold-beacon");
            if (beacon != null) beacon.readChat(raw);
        } catch (Throwable t) {
