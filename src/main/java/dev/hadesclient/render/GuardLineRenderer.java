...
import net.minecraft.client.render.MiscRenderLayers;
...
public final class GuardLineRenderer {
    ...
    private static void doRender(WorldRenderContext context) {
        ...
        VertexConsumer consumer = context.consumers().getBuffer(MiscRenderLayers.LINES);
        Vec3d cameraPos = context.worldState().cameraPos;
        ...
        for (Entity entity : client.world.getEntities()) {
            ...
            if (client.player.squaredDistanceTo(entity) > rangeSquared) continue;
            ...
            GuardLineRenderLayer.addVertex(consumer, startX, startY, startZ, red, green, blue, alpha, 2.0f);
            GuardLineRenderLayer.addVertex(consumer, endX, endY, endZ, red, green, blue, alpha, 2.0f);
        }
    }
}
