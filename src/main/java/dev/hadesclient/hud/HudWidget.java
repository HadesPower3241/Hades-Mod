...
public abstract class HudWidget {
    ...
    public static void setEditorMode(boolean mode) { editorMode = mode; }
    public static boolean isEditor() { return editorMode; }
    ...
    /** Apply text opacity to a color independently. */
    protected Color tc(Color c){return c.alpha(txtAlpha());}

    /** Draw background + border using INDEPENDENT opacity settings. */
    ...
    /** Draw text using INDEPENDENT text opacity + shadow. */
